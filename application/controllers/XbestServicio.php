...
class  XbestServicio extends CI_Controller {
    ...
    public function getProductosByLike(){
        ...
        $host = "https://xbestwebapi.abexacloud.com/api/getProductosByLike";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    public function getProductosById(){
        ...
        $host = "https://xbestwebapi.abexacloud.com/api/GetProductosPorCodigo";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    public function getProductosMasVendidos(){
        $codproductos = "";
        $host = "https://xbestwebapi.abexacloud.com/api/GetProductosMasVendidos";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    public function getProductosByCategoria(){
        ...
        $host = "https://xbestwebapi.abexacloud.com/api/GetProductosActivos";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    public function getProductosByCategoriaMult(){
        ...
        $host = "https://xbestwebapi.abexacloud.com/api/getProductosMultipleCat";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    public function getTipoCambio(){
        $codCategoria = $this->input->post('codcategorias');
        $host = "https://xbestwebapi.abexacloud.com/api/getTipoCambio";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    */
    ...
    public function getCategorias(){
        ...
        $host = "https://xbestwebapi.abexacloud.com/api/GetCategorias";
        $user_name = 'ABEXA';
        $password = '4B3XA2021';
    ...
    public function getProductos(){
        ...
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL,"https://xbest.abexacloud.com/XbestPruebaPublicada/ServicesPrueba/GetProductosActivos?codCategoria=".$codCategoria);
        curl_setopt($curl, CURLOPT_POST, 1);
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode(array()));
       // curl_setopt($curl, CURLOPT_POSTFIELDS, "rucEmpresa=".$ruc);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
