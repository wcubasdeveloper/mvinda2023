    ...
    function compartirProducto(e){
       // alert(2)
        ...
        //$('img').click(function(){
            ...
            method: 'feed',
            link: url,
            picture: 'https://xbest.abexacloud.com/Adjunto/imagenproducto/20602732402/imgproducto_122.png',
    ...
    function mostrarProductosEnOferta(){
        ...
        $.post(URL_GET_PRODUCTOS, data, function (rpta) {
            ...
            if(rpta.length == 1){
                ...
                var urlimagen = ( urlproducto.length == 0 ? '<?=base_url()?>assets/abelostyle/assets/images/product-image/6.jpg' : 'https://xbest.abexacloud.com/Adjunto/imagenproducto/20602732402/'+ urlproducto )
